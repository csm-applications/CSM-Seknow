                    ...
                    <div class="col-md-6 mx-auto">
                        <div class="card mx-4">
                            <div class="card-body p-4">
                                ...
                                ?>
                                <p class="text-muted">Gestor, crie sua conta</p>
                                ...
                                <form action="manager.php" method="POST">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control" disabled="true" >
                                                <option  selected value="14" name="type">Manager</option>
                                            </select>
                                        </div>
                                    ...
                                    <input type="submit" value="Cadastrar Gestor" class="btn btn-block btn-success"/>
                                    <a class="btn btn-block btn-primary" href="user.php" >Ir para cadastro de funcionário</a>
                                </form>
                            </div>
                        </div>
                    </div>
